...
def main(cfgs: DictConfig):
    ...
    # Train and evaluate
    model_ft = train_model(model, dataloaders_dict, device, criterion, optimizer_ft, logger, cfgs=cfgs,
...
def train_model(model, dataloaders, device, criterion, optimizer, logger, cfgs, tensorboard_plugin=None, is_inception=False):
